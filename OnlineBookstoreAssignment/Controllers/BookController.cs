...
public class BookController : Controller
{
    ...
    public static List<Book> allTheBooks = new List<Book>
    {
        ...
        new Book { Id = 2, ISBN = "2",Title = "Book Two", Author = "Author B", Publisher = "Publisher B", Genre = "Genre B", Price = "14.99", Quantity = "5", Description = "A deep dive into the mysteries of life.", Category = "Philosophy", Image = "image2.jpg" },
        ...
        new Book { Id = 4, ISBN = "4",Title = "Book Four", Author = "Author D", Publisher = "Publisher D", Genre = "Genre D", Price = "24.99", Quantity = "7", Description = "A thrilling story of courage and bravery.", Category = "History", Image = "image4.jpg" },
        ...
        new Book { Id = 6, ISBN = "6",Title = "Book Six", Author = "Author F", Publisher = "Publisher F", Genre = "Genre F", Price = "12.99", Quantity = "8", Description = "A gripping narrative of suspense and intrigue.", Category = "Thriller", Image = "image6.jpg" },
        ...
        new Book { Id = 9, ISBN = "9",Title = "Book Nine", Author = "Author I", Publisher = "Publisher I", Genre = "Genre I", Price = "20.99", Quantity = "9", Description = "An enchanting story of magic and wonder.", Category = "Science Fiction", Image = "image9.jpg" },
        new Book { Id = 10, ISBN = "10",Title = "Book Ten", Author = "Author J", Publisher = "Publisher J", Genre = "Genre J", Price = "18.99", Quantity = "1", Description = "A thrilling conclusion to an epic saga.", Category = "Adventure", Image = "image10.jpg" }
    };
